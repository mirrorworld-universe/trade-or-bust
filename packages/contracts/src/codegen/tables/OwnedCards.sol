...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("OwnedCards")));
bytes32 constant OwnedCardsTableId = _tableId;
...
library OwnedCards {
  ...
  /** Get array */
  function get(bytes32 key) internal view returns (uint256[] memory array) {
  ...
  function get(IStore _store, bytes32 key) internal view returns (uint256[] memory array) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  /** Set array */
  function set(bytes32 key, uint256[] memory array) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;

    StoreSwitch.setField(_tableId, _keyTuple, 0, EncodeArray.encode((array)), getValueSchema());
  }

  /** Set array (using the specified store) */
  function set(IStore _store, bytes32 key, uint256[] memory array) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;

    _store.setField(_tableId, _keyTuple, 0, EncodeArray.encode((array)), getValueSchema());
  }
   ...
   */
  function getItem(bytes32 key, uint256 _index) internal view returns (uint256) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * (unchecked, returns invalid data if index overflows)
   */
  function getItem(IStore _store, bytes32 key, uint256 _index) internal view returns (uint256) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  function push(bytes32 key, uint256 _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  function push(IStore _store, bytes32 key, uint256 _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   */
  function update(bytes32 key, uint256 _index, uint256 _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
   ...
   * (checked only to prevent modifying other tables; can corrupt own data if index overflows)
   */
  function update(IStore _store, bytes32 key, uint256 _index, uint256 _element) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  function encode(uint256[] memory array) internal pure returns (bytes memory) {
    ...
    unchecked {
      _encodedLengths = PackedCounterLib.pack(array.length * 32);
    }

    return abi.encodePacked(_encodedLengths.unwrap(), EncodeArray.encode((array)));
  }
