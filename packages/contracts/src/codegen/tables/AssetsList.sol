...
bytes32 constant _tableId = bytes32(abi.encodePacked(bytes16(""), bytes16("AssetsList")));
bytes32 constant AssetsListTableId = _tableId;
...
library AssetsList {
  ...
  function setGpu(bytes32 key, int8 gpu) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 0, abi.encodePacked((gpu)), getValueSchema());
  }
  ...
  function setGpu(IStore _store, bytes32 key, int8 gpu) internal {
    ...
    _store.setField(_tableId, _keyTuple, 0, abi.encodePacked((gpu)), getValueSchema());
  }
  ...
  function setBitcoin(bytes32 key, int8 bitcoin) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 1, abi.encodePacked((bitcoin)), getValueSchema());
  }
  ...
  function setBitcoin(IStore _store, bytes32 key, int8 bitcoin) internal {
    ...
    _store.setField(_tableId, _keyTuple, 1, abi.encodePacked((bitcoin)), getValueSchema());
  }
  ...
  function setBattery(bytes32 key, int8 battery) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 2, abi.encodePacked((battery)), getValueSchema());
  }
  ...
  function setBattery(IStore _store, bytes32 key, int8 battery) internal {
    ...
    _store.setField(_tableId, _keyTuple, 2, abi.encodePacked((battery)), getValueSchema());
  }
  ...
  function setLeiter(bytes32 key, int8 leiter) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 3, abi.encodePacked((leiter)), getValueSchema());
  }
  ...
  function setLeiter(IStore _store, bytes32 key, int8 leiter) internal {
    ...
    _store.setField(_tableId, _keyTuple, 3, abi.encodePacked((leiter)), getValueSchema());
  }
  ...
  function setGold(bytes32 key, int8 gold) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 4, abi.encodePacked((gold)), getValueSchema());
  }
  ...
  function setGold(IStore _store, bytes32 key, int8 gold) internal {
    ...
    _store.setField(_tableId, _keyTuple, 4, abi.encodePacked((gold)), getValueSchema());
  }
  ...
  function setOil(bytes32 key, int8 oil) internal {
    ...
    StoreSwitch.setField(_tableId, _keyTuple, 5, abi.encodePacked((oil)), getValueSchema());
  }
  ...
  function setOil(IStore _store, bytes32 key, int8 oil) internal {
    ...
    _store.setField(_tableId, _keyTuple, 5, abi.encodePacked((oil)), getValueSchema());
  }
  ...
  function get(IStore _store, bytes32 key) internal view returns (AssetsListData memory _table) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = key;
  ...
  function set(bytes32 key, int8 gpu, int8 bitcoin, int8 battery, int8 leiter, int8 gold, int8 oil) internal {
    bytes memory _data = encode(gpu, bitcoin, battery, leiter, gold, oil);
  ...
  function set(bytes32 key, AssetsListData memory _table) internal {
    set(key, _table.gpu, _table.bitcoin, _table.battery, _table.leiter, _table.gold, _table.oil);
  }

  /** Set the full data using the data struct (using the specified store) */
  function set(IStore _store, bytes32 key, AssetsListData memory _table) internal {
    set(_store, key, _table.gpu, _table.bitcoin, _table.battery, _table.leiter, _table.gold, _table.oil);
  }

  /** Decode the tightly packed blob using this table's schema */
  function decode(bytes memory _blob) internal pure returns (AssetsListData memory _table) {
    _table.gpu = (int8(uint8(Bytes.slice1(_blob, 0))));

    _table.bitcoin = (int8(uint8(Bytes.slice1(_blob, 1))));

    _table.battery = (int8(uint8(Bytes.slice1(_blob, 2))));

    _table.leiter = (int8(uint8(Bytes.slice1(_blob, 3))));

    _table.gold = (int8(uint8(Bytes.slice1(_blob, 4))));

    _table.oil = (int8(uint8(Bytes.slice1(_blob, 5))));
  }
