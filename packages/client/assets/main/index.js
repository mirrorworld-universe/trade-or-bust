System.register("chunks:///_virtual/aaa.ts", ['cc'], function () {
  var cclegacy;
  return {
    ...
    execute: function () {
      cclegacy._RF.push({}, "13a7b+zOlNER4ceZ2CY7c9q", "aaa", undefined);
...
System.register("chunks:///_virtual/button_raisingcapital.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ponzi-controller.ts', './ccc_msg.ts', './time_utils.ts', './component_state.ts', './ponzi_config.ts', './RoleLocalObj.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _asyncToGenerator, _regeneratorRuntime, cclegacy, _decorator, Label, Button, log, sys, Component, warn, ponzi_controller, ccc_msg, time_utils, component_state, ponzi_config, RoleLocalObj;
      ...
      var button_raisingcapital = exports('button_raisingcapital', (_dec = ccclass('button_raisingcapital'), _dec2 = property({
        ...
        _proto.init = /*#__PURE__*/function () {
          var _init = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
            var gameState, playerEntity, player, array, key, map, hash, obj;
              ...
              while (1) switch (_context3.prev = _context3.next) {
                ...
                case 8:
                  ...
                  try {
                    ...
                    for (key in globalThis.ponzi.players) {
                      map = globalThis.ponzi.players[key];
                      hash = map.player;
        ...
        _proto.updateUI = /*#__PURE__*/function () {
          var _updateUI = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
            var playerEntity, player, array, key, map, hash, raiseCountdown, timeStamp, useableTime;
            return _regeneratorRuntime().wrap(function _callee4$(_context4) {
              while (1) switch (_context4.prev = _context4.next) {
                ...
                case 10:
                  ...
                  useableTime = Number(raiseCountdown.coolDownEndedAtTimestamp.toNumber());
        ...
        _proto._registerListeners = function _registerListeners() {
          var self = this;
          ponzi_controller.instance.on(ccc_msg.on_raisecolddown_update, /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(update) {
        ...
        _proto.startCountDownAnimation = function startCountDownAnimation() {
          ...
          this.timer = setTimeout( /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6() {
...
System.register("chunks:///_virtual/Components.ts", ['cc'], function (exports) {
  var cclegacy;
  return {
    setters: [function (module) {
      cclegacy = module.cclegacy;
    ...
    execute: function () {
      cclegacy._RF.push({}, "c7db93ZU3FP3ZiLdp4uBERg", "Components", undefined);
      ...
      var GameMap = exports('GameMap', function GameMap() {
        this.width = void 0;
        this.height = void 0;
        this.mapArray = void 0;
      });
      ...
      var IsPlayer = exports('IsPlayer', function IsPlayer() {
        this.value = void 0;
      });
      var RaiseColddown = exports('RaiseColddown', function RaiseColddown() {
        this.start = void 0;
        this.end = void 0;
      });
      var AssetsList = exports('AssetsList', function AssetsList() {
        this.gpu = void 0;
        this.bitcoin = void 0;
        this.battery = void 0;
        this.leiter = void 0;
      ...
      var TransactionList = exports('TransactionList', function TransactionList() {
        this.list = void 0;
      });
      var TradeList = exports('TradeList', function TradeList() {
        this.list = void 0;
      });
      var IsTrading = exports('IsTrading', function IsTrading() {
        this.value = void 0;
      });
      var PlayerGameResult = exports('PlayerGameResult', function PlayerGameResult() {
        this.rank = void 0;
        this.points = void 0;
        this.gpu = void 0;
        this.bitcoin = void 0;
      ...
      var PassiveTransaction = exports('PassiveTransaction', function PassiveTransaction() {
        this.asset = void 0;
        this.money = void 0;
        this.from = void 0;
      });
...
System.register("chunks:///_virtual/lobby-controller.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './component_state.ts', './ponzi-controller.ts', './ccc_msg.ts', './string_utils.ts', './solana-bridge.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _asyncToGenerator, _regeneratorRuntime, cclegacy, _decorator, Label, Node, Component, log, sys, warn, component_state, ponzi_controller, ccc_msg, string_utils, solana_bridge;
            ...
            return _regeneratorRuntime().wrap(function _callee2$(_context2) {
              while (1) switch (_context2.prev = _context2.next) {
                case 0:
                  ...
                  y = Math.floor(Math.random() * 6) + 7;
                  _context2.next = 5;
                  return window.solanaJoinGame(x, y);

                case 5:
                  //todo: update IsPlayer and sync here
                  globalThis.ponzi.gameState = component_state.game_ingame;
                  _context2.next = 8;
                  return solana_bridge.instance.updateGame();
                ...
                case 10:
                  _context2.next = 12;
                  return solana_bridge.instance.updateGameMap();
                ...
                case 32:
                  if (gameState == component_state.game_waiting) {
                    ...
                    if (isPlayer) {
                      ...
                      _gameStartTime = Number(gameObj.gameStartedAtTimestamp);
    ...
    execute: function () {
      ...
      var map_controller = exports('map_controller', (_dec = ccclass('map_controller'), _dec2 = property({
        ...
        _proto.init = function init() {
          ...
          if (!map) return; // let items = window.getMapItems?.();
          // if(!items) return;
...
System.register("chunks:///_virtual/mapblock.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ponzi-controller.ts', './ccc_msg.ts', './data_center.ts', './coor_utils.ts', './solana-bridge.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _asyncToGenerator, _regeneratorRuntime, cclegacy, _decorator, Label, Node, Component, log, ponzi_controller, ccc_msg, data_center, coor_utils, solana_bridge;
            ...
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  ...
                  _context.prev = 3;
                  _context.next = 6;
                  return solana_bridge.instance.move_player(self.mapTile.col, self.mapTile.row);
...
System.register("chunks:///_virtual/pick_asset.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ponzi-controller.ts', './ccc_msg.ts', './pick_asset_item.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _asyncToGenerator, _regeneratorRuntime, cclegacy, _decorator, Node, Component, log, warn, ponzi_controller, ccc_msg, pick_asset_item;
      ...
      var pick_asset = exports('pick_asset', (_dec = ccclass('pick_asset'), _dec2 = property({
        ...
        _proto.onPickClicked = /*#__PURE__*/function () {
          var _onPickClicked = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
            var assetsList, allPlayers, i, p, aaa;
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                ...
                case 4:
                  ...
                  _context.prev = 5;
                  _context.next = 8;
                  return window.solanaPickAsset(this.pickAsset);
                ...
                case 21:
                  if (!assetsList) {
                    ...
                    ponzi_controller.instance.sendCCCMsg(ccc_msg.on_assetslist_update, {
                      entity: globalThis.ponzi.currentPlayer
                    });
                  }
...
System.register("chunks:///_virtual/pick-money-card.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './fond_card.ts', './ponzi-controller.ts', './ccc_msg.ts', './solana-bridge.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _asyncToGenerator, _regeneratorRuntime, cclegacy, _decorator, Node, log, Component, fond_card, ponzi_controller, ccc_msg, solana_bridge;
            ...
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  ponzi_controller.instance.sendCCCMsg(ccc_msg.network_block_ui, true);
                  _context.next = 3;
                  return window.solanaPickFund();

                case 3:
                  _context.next = 5;
                  return solana_bridge.instance.updatePlayerObj();
...
System.register("chunks:///_virtual/player-model.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Node, log, Component;
...
System.register("chunks:///_virtual/popupui_manager.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ponzi-controller.ts', './ccc_msg.ts', './single-button-pop.ts', './pick_asset.ts', './pick-money-card.ts', './rules.ts', './trade.ts', './trade-ask.ts', './trade_input_price.ts', './rank.ts', './popeffect.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Node, Component, ponzi_controller, ccc_msg, single_button_pop, pick_asset, pick_money_card, rules, trade, trade_ask, trade_input_price, rank, popeffect;
...
System.register("chunks:///_virtual/right-player-list.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './right-player-list-item.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Node, instantiate, Component, right_player_list_item;
  ...
  return {
    ...
    execute: function () {
      ...
      var right_player_list = exports('right_player_list', (_dec = ccclass('right_player_list'), _dec2 = property({
        ...
        _proto.init = function init() {
          var assetsListArray = globalThis.ponzi.players;
          ...
          for (var i = 0; i < assetsListArray.length; i++) {
            var map = assetsListArray[i];
...
System.register("chunks:///_virtual/solana-bridge.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './component_state.ts', './ponzi-controller.ts', './ccc_msg.ts', './RoleLocalObj.ts'], function (exports) {
  var _inheritsLoose, _createClass, _asyncToGenerator, _regeneratorRuntime, cclegacy, _decorator, error, find, Component, log, component_state, ponzi_controller, ccc_msg, RoleLocalObj;
  ...
  return {
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "e9345K54CZA5qno8sXSWXwr", "solana-bridge", undefined); // import { aaa } from "./aaa";


      var ccclass = _decorator.ccclass,
          property = _decorator.property;
      var solana_bridge = exports('solana_bridge', (_dec = ccclass('solana_bridge'), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        _inheritsLoose(solana_bridge, _Component);

        function solana_bridge() {
          var _this;
          ...
          _this = _Component.call.apply(_Component, [this].concat(args)) || this; //Get from url

          _this.game_id = void 0;
          _this.current_player = void 0;
          _this.players = void 0;
          _this.game = {};
          _this.GameState = {};
          _this.GameMap = {}; // private players:Map<string,any> = new Map<string,any>();

          _this.isPlayers = new Map();
          _this.MapItems = new Map();
          _this.TransactionLists = new Map();
          _this.AssetsLists = new Map();
          _this.RaiseColddowns = new Map();
          _this.PassiveTransactions = new Map();
          _this.TradeLists = new Map();
        ...
        var _proto = solana_bridge.prototype; //Query from chain directely, not backend

        _proto.queryFromChain = function queryFromChain(id) {
          if (typeof id === 'string') ;else if (Array.isArray(id)) ;else {
            ...
            return _regeneratorRuntime().wrap(function _callee$(_context) {
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  ...
                  log("game_id:", this.game_id, " current player:", this.current_player); //InitSDK
        ...
        _proto.updateGame = /*#__PURE__*/function () {
          var _updateGame = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
            var gameInfo, _window2;
            ...
            return _regeneratorRuntime().wrap(function _callee2$(_context2) {
              while (1) switch (_context2.prev = _context2.next) {
                ...
                case 4:
                  ...
                  globalThis.ponzi.game_update == null ? void 0 : globalThis.ponzi.game_update(null, gameInfo); //Update gameState

                  globalThis.ponzi.gameState = component_state.game_ingame;
                  globalThis.ponzi.gamestate_update == null ? void 0 : globalThis.ponzi.gamestate_update(null, component_state.game_ingame);
                  _context2.next = 12;
                  return solana_bridge.instance.updateGameMap();
                ...
                case 14:
                  ...
                  log(" query game failed", _context2.t0);
                  globalThis.ponzi.game = 1; //Update gameState

                  globalThis.ponzi.gameState = component_state.game_waiting;
                  globalThis.ponzi.gamestate_update == null ? void 0 : globalThis.ponzi.gamestate_update(null, component_state.game_waiting);
        ...
        _proto.updateGameMap = /*#__PURE__*/function () {
          var _updateGameMap = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
            return _regeneratorRuntime().wrap(function _callee3$(_context3) {
              while (1) switch (_context3.prev = _context3.next) {
                case 0:
          ...
          function updateGameMap() {
            return _updateGameMap.apply(this, arguments);
          }

          return updateGameMap;
        }();

        _proto.updatePlayers = /*#__PURE__*/function () {
          var _updatePlayers = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4() {
            var _window3;

            var playerIds, playersData;
            return _regeneratorRuntime().wrap(function _callee4$(_context4) {
              while (1) switch (_context4.prev = _context4.next) {
                case 0:
                  //Query all players
          ...
          function updatePlayers() {
            return _updatePlayers.apply(this, arguments);
          }
        ...
        _proto.queryAll = function queryAll() {
          this.queryFromChain([this.game_id]);
          this.queryFromChain(["player_id_xxx4", "player_id_xxx5", "player_id_xxx6"]);
          this.queryFromChain(["player_id_xxx1", "player_id_xxx2", "player_id_xxx3"]); //todo:...
        };

        _proto.queryPlayer = function queryPlayer(playerKey) {
          if (!globalThis.ponzi.players) {
            console.error("game not inited!");
            return null;
          }

          for (var key in globalThis.ponzi.players) {
            var map = globalThis.ponzi.players[key];
            var hash = map.player;
            if (playerKey == hash) return map;
          }
        };

        _proto.move_player = /*#__PURE__*/function () {
          var _move_player = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(x, y) {
            return _regeneratorRuntime().wrap(function _callee6$(_context6) {
              while (1) switch (_context6.prev = _context6.next) {
                case 0:
                  _context6.next = 2;
                  return window.solanaMovePlayer(x, y);

                case 2:
                  _context6.next = 4;
                  return this.updatePlayerObj();
          ...
          function move_player(_x, _x2) {
            return _move_player.apply(this, arguments);
          }

          return move_player;
        }();

        _proto.updatePlayerObj = /*#__PURE__*/function () {
          var _updatePlayerObj = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7() {
            var array, key, map, hash, obj, old, oldObj, _key2, _map, _hash, _obj, newa, newObj;
            ...
            return _regeneratorRuntime().wrap(function _callee7$(_context7) {
              while (1) switch (_context7.prev = _context7.next) {
                case 0:
                  ...
                  old = array[globalThis.ponzi.currentPlayer];
                  oldObj = {
                    x: old.row,
                    y: old.col,
                    money: old.money
                ...
                case 6:
                  for (_key2 in globalThis.ponzi.players) {
                    _map = globalThis.ponzi.players[_key2];
                    _hash = _map.player;

                    if (!array[_hash]) {
                      array[_hash] = new RoleLocalObj();
                    }

                    _obj = array[_hash];
                    array[_hash] = _obj;
                    _obj.row = _map.y.toNumber();
                    _obj.col = _map.x.toNumber();
                    _obj.money = _map.money.toNumber();
                  }

                  newa = array[globalThis.ponzi.currentPlayer];
                  newObj = {
                    x: newa.row,
                    y: newa.col,
                    money: newa.money
          ...
          function updatePlayerObj() {
            return _updatePlayerObj.apply(this, arguments);
          }

          return updatePlayerObj;
        }();

        _proto.accept_trade = function accept_trade(player_id, trade_id) {//todo: send accept_trade to chain
          //todo: query PassiveTransaction of player_id
          //todo: query TradeList of player_id
        };

        _proto.cancel_trade = function cancel_trade() {//Have no idea
        };

        _proto.create_trade = function create_trade(player_id, target_player, money, asset_id) {//todo: send create_trade to chain
          //todo: query TradeList of player_id
        };

        _proto.initialize_game_config = function initialize_game_config(game_id) {//have no idea how to use this function
        };

        _proto.join_game = function join_game(player_id) {//todo: send join_game
          //todo: query IsPlayer of player_id
        };

        _proto.pick_asset = function pick_asset(player_id, asset_id) {//todo: send pick
          //todo: query cold down
          //todo: query AssetList of player_id
        };

        _proto.pick_fund = function pick_fund(player_id, fund_id) {//todo: send pick
          //todo: query Player of player_id
        };

        _proto.reject_trade = function reject_trade() {//todo: send reject_trade
          //todo: query TradeList of player_id
        } //Convert big data object to components which like mud
        ;

        _proto.divideToComponent = function divideToComponent() {};

        _proto.getTodayStartTimestamp = function getTodayStartTimestamp() {
          var now = new Date();
        ...
        _proto.getParameterFromURL = function getParameterFromURL(parameterName) {
          var urlParams = new URLSearchParams(window.location.search);
          return urlParams.get(parameterName);
        };

        _createClass(solana_bridge, null, [{
          key: "instance",
          get: function get() {
...
System.register("chunks:///_virtual/title-money.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ponzi-controller.ts', './ccc_msg.ts', './solana-bridge.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _asyncToGenerator, _regeneratorRuntime, cclegacy, _decorator, Label, Component, ponzi_controller, ccc_msg, solana_bridge;
...
System.register("chunks:///_virtual/trade.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './trade-asset-item.ts', './ponzi-controller.ts', './ccc_msg.ts', './trade_parter_item.ts', './string_utils.ts', './temp_data.ts', './popeffect.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, _asyncToGenerator, _regeneratorRuntime, _createForOfIteratorHelperLoose, cclegacy, _decorator, Node, Component, instantiate, Vec3, log, trade_asset_item, ponzi_controller, ccc_msg, trade_parter_item, string_utils, temp_data, popeffect;
      ...
      var trade = exports('trade', (_dec = ccclass('trade'), _dec2 = property({
        ...
        _proto.init = /*#__PURE__*/function () {
          var _init = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
            var matchingEntities, me, _iterator, _step, playerEntity, al, newNode, script, name;
            ...
            return _regeneratorRuntime().wrap(function _callee2$(_context2) {
              while (1) switch (_context2.prev = _context2.next) {
                ...
                case 7:
                  ...
                  if (!(me == string_utils.getHashFromSymbol(playerEntity))) {
                    _context2.next = 11;
                    break;
                  }
